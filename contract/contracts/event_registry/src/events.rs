pub use crate::topics::EventHivezEvent;

use soroban_sdk::{contracttype, Address, String};

/// Emitted when an event is permanently cancelled.
///
/// Published with topic `(EventHivezEvent::EventCancelled,)`.
#[contracttype]
...
/// Published with topic `(EventHivezEvent::EventArchived,)`.
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
///
/// Published with topic `(EventHivezEvent::EventRegistered,)`.
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
///
/// Published with topic `(EventHivezEvent::EventStatusUpdated,)`.
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
///
/// Published with topic `(EventHivezEvent::FeeUpdated,)`.
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
///
/// Published with topic `(EventHivezEvent::ContractInitialized,)`.
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
///
/// Published with topic `(EventHivezEvent::ContractUpgraded,)`.
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
///
/// Published with topic `(EventHivezEvent::MetadataUpdated,)`.
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
///
/// Published with topic `(EventHivezEvent::InventoryIncremented,)`.
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
///
/// Published with topic `(EventHivezEvent::InventoryDecremented,)`.
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
///
/// Published with topic `(EventHivezEvent::OrganizerBlacklisted,)`.
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
///
/// Published with topic `(EventHivezEvent::OrganizerRemovedFromBlacklist,)`.
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
/// Published with topic `(EventHivezEvent::EventsSuspended,)`.
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
///
/// Published with topic `(EventHivezEvent::GlobalPromoUpdated,)`.
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
/// Published with topic `(EventHivezEvent::EventPostponed,)`.
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
///
/// Published with topic `(EventHivezEvent::ProposalCreated,)` (used internally).
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
///
/// Published with topic `(EventHivezEvent::ProposalApproved,)` (used internally).
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
///
/// Published with topic `(EventHivezEvent::ProposalExecuted,)` (used internally).
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
///
/// Published with topic `(EventHivezEvent::ProposalCancelled,)`.
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
/// at the event venue. Published with topic `(EventHivezEvent::ScannerAuthorized,)`.
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
///
/// Published with topic `(EventHivezEvent::ScannerRevoked,)`.
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
/// Published with topic `(EventHivezEvent::GoalMet,)`.
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
/// threshold for Verified status. Published with topic `(EventHivezEvent::CollateralStaked,)`.
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
/// the stakers list. Published with topic `(EventHivezEvent::CollateralUnstaked,)`.
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
/// Published with topic `(EventHivezEvent::StakerRewardsDistributed,)`.
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
///
/// Published with topic `(EventHivezEvent::StakerRewardsClaimed,)`.
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
/// defined tiers. Published with topic `(EventHivezEvent::LoyaltyScoreUpdated,)`.
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
/// or charitable events). Published with topic `(EventHivezEvent::CustomFeeSet,)`.
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
///
/// Published with topic `(EventHivezEvent::FeedbackCidSet,)`.
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
///
/// Published with topic `(EventHivezEvent::TokenWhitelistUpdated,)`.
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
///
/// Published with topic `(EventHivezEvent::WaitlistJoined,)`.
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
