...
use crate::events::{
    EventHivezEvent, CollateralStakedEvent, CollateralUnstakedEvent, CustomFeeSetEvent,
...
impl EventRegistry {
    ...
    pub fn initialize(
        ...
        env.events().publish(
            (EventHivezEvent::ContractInitialized,),
            InitializationEvent {
                admin_address: admin,
                platform_wallet,
    ...
    pub fn register_event(env: Env, args: EventRegistrationArgs) -> Result<(), EventRegistryError> {
        ...
        env.events().publish(
            (EventHivezEvent::EventRegistered,),
    ...
    pub fn update_event_status(
        ...
        match storage::get_event(&env, event_id.clone()) {
            Some(mut event_info) => {
                ...
                env.events().publish(
                    (EventHivezEvent::EventStatusUpdated,),
    ...
    pub fn cancel_event(env: Env, event_id: String) -> Result<(), EventRegistryError> {
        match storage::get_event(&env, event_id.clone()) {
            Some(mut event_info) => {
                ...
                env.events().publish(
                    (EventHivezEvent::EventCancelled,),
                    EventCancelledEvent {
                        event_id,
    ...
    pub fn update_metadata(
        ...
        match storage::get_event(&env, event_id.clone()) {
            Some(mut event_info) => {
                ...
                env.events().publish(
                    (EventHivezEvent::MetadataUpdated,),
    ...
    pub fn increment_inventory(
        ...
        env.events().publish(
            (EventHivezEvent::InventoryIncremented,),
    ...
    pub fn decrement_inventory(
        ...
        env.events().publish(
            (crate::events::EventHivezEvent::InventoryDecremented,),
    ...
    pub fn upgrade(env: Env, new_wasm_hash: BytesN<32>) -> Result<(), EventRegistryError> {
        ...
        env.events().publish(
            (EventHivezEvent::ContractUpgraded,),
    ...
    pub fn blacklist_organizer(
        ...
        env.events().publish(
            (EventHivezEvent::OrganizerBlacklisted,),
    ...
    pub fn remove_from_blacklist(
        ...
        // Emit removal event
        env.events().publish(
            (EventHivezEvent::OrganizerRemovedFromBlacklist,),
    ...
    pub fn set_global_promo(
        ...
        env.events().publish(
            (EventHivezEvent::GlobalPromoUpdated,),
    ...
    pub fn postpone_event(
        ...
        env.events().publish(
            (EventHivezEvent::EventPostponed,),
            EventPostponedEvent {
                event_id,
                organizer_address: event_info.organizer_address,
                grace_period_end,
    ...
    pub fn authorize_scanner(
        ...
        env.events().publish(
            (EventHivezEvent::ScannerAuthorized,),
    ...
    pub fn revoke_scanner(
        ...
        env.events().publish(
            (EventHivezEvent::ScannerRevoked,),
            ScannerRevokedEvent {
                event_id,
                scanner,
    ...
    pub fn stake_collateral(
        ...
        env.events().publish(
            (EventHivezEvent::CollateralStaked,),
    ...
    pub fn unstake_collateral(env: Env, organizer: Address) -> Result<(), EventRegistryError> {
        ...
        env.events().publish(
            (EventHivezEvent::CollateralUnstaked,),
    ...
    pub fn distribute_staker_rewards(
        ...
        env.events().publish(
            (EventHivezEvent::StakerRewardsDistributed,),
            StakerRewardsDistributedEvent {
                total_reward,
                staker_count,
                timestamp: env.ledger().timestamp(),
    ...
    pub fn claim_staker_rewards(env: Env, organizer: Address) -> Result<i128, EventRegistryError> {
        ...
        env.events().publish(
            (EventHivezEvent::StakerRewardsClaimed,),
    ...
    pub fn update_loyalty_score(
        ...
        env.events().publish(
            (EventHivezEvent::LoyaltyScoreUpdated,),
...
fn suspend_organizer_events(
    ...
    if suspended_count > 0 {
        ...
        #[allow(deprecated)]
        env.events().publish(
            (EventHivezEvent::EventsSuspended,),
