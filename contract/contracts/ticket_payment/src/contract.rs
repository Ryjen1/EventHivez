...
use crate::{
    ...
    events::{
        EventHivezEvent, AuctionClosedEvent, BidPlacedEvent, BulkRefundProcessedEvent,
...
impl TicketPaymentContract {
    ...
    pub fn set_pause(env: Env, paused: bool) -> Result<(), TicketPaymentError> {
        ...
        #[allow(deprecated)]
        env.events().publish(
            (EventHivezEvent::ContractPaused,),
            ContractPausedEvent {
                paused,
    ...
    pub fn set_event_dispute(
        ...
        env.events().publish(
            (EventHivezEvent::DisputeStatusChanged,),
    ...
    pub fn propose_parameter_change(
        ...
        env.events().publish(
            (EventHivezEvent::ProposalCreated,),
    ...
    pub fn execute_proposal(
        ...
        env.events().publish(
            (EventHivezEvent::GovernanceActionExecuted,),
    ...
    pub fn process_payment(
        ...
        env.events().publish(
            (EventHivezEvent::PaymentProcessed,),
        ...
        if let Some(hash) = discount_code_hash {
            ...
            env.events().publish(
                (EventHivezEvent::DiscountCodeApplied,),
        ...
        if promo_applied_bps > 0 {
            ...
            env.events().publish(
                (EventHivezEvent::GlobalPromoApplied,),
    ...
    pub fn confirm_payment(env: Env, payment_id: String, transaction_hash: String) {
        ...
        #[allow(deprecated)]
        env.events().publish(
            (EventHivezEvent::PaymentStatusChanged,),
    ...
    //     #[allow(deprecated)]
    //     env.events().publish(
    //         (EventHivezEvent::TicketCheckedIn,),
    ...
    pub fn claim_revenue(
        ...
        #[allow(deprecated)]
        env.events().publish(
            (EventHivezEvent::RevenueClaimed,),
            RevenueClaimedEvent {
                event_id,
    ...
    pub fn transfer_ticket(
        ...
        #[allow(deprecated)]
        env.events().publish(
            (EventHivezEvent::TicketTransferred,),
    ...
    pub fn trigger_bulk_refund(
        ...
        #[allow(deprecated)]
        env.events().publish(
            (EventHivezEvent::BulkRefundProcessed,),
    ...
    pub fn issue_partial_refund(
        ...
        #[allow(deprecated)]
        env.events().publish(
            (EventHivezEvent::PartialRefundProcessed,),
    ...
    pub fn claim_cancellation_refund(
        ...
        env.events().publish(
            (EventHivezEvent::CancellationRefundClaimed,),
