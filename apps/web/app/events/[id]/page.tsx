...
export async function generateMetadata({
  ...
  return buildMetadata({
    title: event.title,
    description: `Join us for ${event.title} on ${event.date} in ${event.location}. ${event.price === "Free" ? "Free entry." : `Tickets from $${event.price}.`} Secure your spot on EventHivez.`,
