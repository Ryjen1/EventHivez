...
export const mockArticles: Article[] = [
  {
    slug: "what-is-eventhivez",
    title: "What is EventHivez?",
    categorySlug: "getting-started",
    content: "# What is EventHivez?\n\nEventHivez is a decentralized event management platform...\n\n## Getting Started\n\n1. Sign up for an account\n2. Create an event\n3. Sell tickets",
  },
  {
    slug: "how-to-buy-tickets",
    title: "How to Buy Tickets",
    categorySlug: "buying-tickets",
    content: "# How to Buy Tickets\n\nBuying tickets on EventHivez is simple.\n\n## Steps\n\n- Navigate to an event page\n- Click **Buy Ticket**\n- Confirm transaction in your wallet",
  }
];
