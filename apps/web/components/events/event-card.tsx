      ...
      <div className="w-full sm:max-w-147.5 shadow-[-4px_4px_0_rgba(124,58,237,0.3)] sm:shadow-[-6px_6px_0_rgba(124,58,237,0.3)] flex flex-col bg-white/5 backdrop-blur-sm border border-white/10 pb-4.75 sm:pl-12.5 pl-4 pt-5 sm:pt-9.75 rounded-xl sm:pr-5 pr-3.75 transition-all hover:scale-[1.02] hover:border-accent/30 overflow-hidden">
        <div className="flex gap-4.75">
          ...
          <div className="flex-shrink-0 w-[40%] sm:w-auto">
            ...
            <div className="flex justify-center font-semibold sm:hidden text-[10px]/2.5 mt-4 text-accent-light">
              {priceLabel}
            </div>
            
            {/* View Event (Mobile Only) */}
            <div className="sm:hidden justify-center flex items-center gap-1 mt-1.5 text-accent-light text-[12px]/7.5 font-medium cursor-pointer">
          ...
          <div className="flex flex-col grow justify-between sm:justify-start min-w-0">
            {/* Date (Desktop) */}
            <span className="font-light text-[15px]/7.5 hidden sm:block text-white/50">
              {date}
            </span>

            {/* Title: Prevent overflow with break-words */}
            <p className="font-semibold text-[14px] sm:text-[15px]/5 mt-1 sm:mt-2.5 break-words leading-tight text-white">
              {title}
            </p>

            {/* Price Label (Desktop) */}
            <div className="max-sm:hidden pr-3 font-semibold sm:text-[13px]/3.25 text-[10px]/2.5 mt-2 self-end text-accent-light">
              {priceLabel}
            </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-1.25 mt-1">
                <Image
                  ...
                  loading="lazy"
                />
                <span className="font-normal text-[11px] sm:text-[12px]/7.5 line-clamp-1 text-white/60">
                  {location}
                </span>
              </div>
            </div>
        ...
        <div className="self-end hidden sm:flex mr-6 gap-1.5 mt-1.5 text-accent-light text-[12px]/7.5 font-medium cursor-pointer">
          View Event
          <Image
            src="/icons/arrow-right.svg"
            width={24}
